...
$form['form-1'] = array(
	...
	'cfg' => array(
		'charset' => 'UTF-8',
		'subject' => 'Заказ топлива с сайта ooomekc.ru',
		'title' => 'Заказ с сайта ooomekc.ru',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'noreply@ooomekc.ru',
		'from_name' => 'noreply',
		'to_email' => 'nav_khv@mail.ru',
		...
		'okay' => 'Ваш заказ принят. Ожидайте звонка.',
		'fuck' => 'Ошибка',
		'spam' => 'Cпам робот',
		'notify' => 'color-modal',
		'usepresuf' => false
